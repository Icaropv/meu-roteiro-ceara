...
const Index = () => {
  return <div className="min-h-screen bg-background">
    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in">
          Descubra o{" "}
          <span className="text-cyan-400 bg-clip-text ">
            Ceará
          </span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button size="lg" className="bg-primary hover:bg-primary/90 shadow-ocean" asChild>
            <a href="#cidades-section">
          ...
          <Button variant="outline" size="lg" asChild>
            <Link
              to="/roteiros"
              className="bg-white text-cyan-400 border border-cyan-400 hover:bg-cyan-400 hover:text-white transition-colors duration-300"
            >
              Ver Roteiros
            </Link>
          </Button>
    ...
    {/* Cidades Section */}
    <section id="cidades-section" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {cidades.map((cidade, index) => <Card key={cidade.id} className="group hover:shadow-zinc-400 hover:shadow-md transition-smooth cursor-pointer transform hover:-translate-y-2" style={{
